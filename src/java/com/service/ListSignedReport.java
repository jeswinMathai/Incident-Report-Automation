...
@ManagedBean
@RequestScoped
public class ListSignedReport implements Serializable{
    ...
    public String viewReport(int id)
    {
        ...
        return "ViewSignedReports.xhtml?id="+id;
    }

    @PostConstruct
    public void init()
    {
        System.out.println("halasdasdsadasds");
        System.out.println(login.getEmpNO());
        ird=new ArrayList<>();
        ird=query.getIrdSignedList(login.getEmpNo());
    }
